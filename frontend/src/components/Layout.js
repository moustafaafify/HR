    ...
    <div className="flex min-h-screen bg-slate-50 noise-texture">
      ...
      `}>
        ...
        <nav className="flex-1 p-3 lg:p-4 space-y-1 overflow-y-auto">
          ...
          {/* My Onboarding/Offboarding for employees */}
          {!isAdmin && (
            <>
              ...
              <NavLink item={{ path: '/timesheets', icon: Sheet, label: 'My Timesheets' }} />
              <NavLink item={{ path: '/projects', icon: FolderKanban, label: 'My Projects' }} />
              <NavLink item={{ path: '/benefits', icon: Heart, label: 'My Benefits' }} />
              ...
              <NavLink item={{ path: '/succession', icon: Target, label: 'My Development' }} />
          ...
          {isAdmin && (
            <>
              ...
              <NavLink item={{ path: '/timesheets', icon: Sheet, label: 'Timesheets' }} />
              <NavLink item={{ path: '/projects', icon: FolderKanban, label: 'Projects' }} />
              <NavLink item={{ path: '/benefits', icon: Heart, label: 'Benefits' }} />
              ...
              <NavLink item={{ path: '/complaints', icon: AlertOctagon, label: 'Complaints' }} />
              <NavLink item={{ path: '/disciplinary', icon: Gavel, label: 'Disciplinary' }} />
              <NavLink item={{ path: '/succession', icon: Target, label: 'Succession' }} />
              <NavLink item={{ path: '/org-chart', icon: Network, label: 'Org Chart' }} />
